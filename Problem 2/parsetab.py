...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',105),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',109),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',113),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',117),
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',121),
  ('items -> item items','items',2,'p_items','yacc.py',125),
  ('items -> empty','items',1,'p_items_empty','yacc.py',129),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',133),
  ('item -> atom','item',1,'p_item_atom','yacc.py',137),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',145),
  ('item -> call','item',1,'p_item_call','yacc.py',149),
  ('item -> empty','item',1,'p_item_empty','yacc.py',153),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',157),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',166),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',170),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',174),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',178),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',182),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',186),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',190),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',194),
]
